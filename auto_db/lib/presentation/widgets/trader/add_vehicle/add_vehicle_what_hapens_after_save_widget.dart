...
class AddVehicleWhatHappensAfterSaveWidget extends StatelessWidget {
  @override
  ...
  Widget _getTitle(BuildContext buildContext){
    return Container(
      ...
      child: Text(
        StringConstants.whatHappensAfterSaveTitle,
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                      text: StringConstants.alreadyVisibleOn + ' ',
              ...
              Expanded(
                ...
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
                        text: StringConstants.whasPopupMessage1,
                        style: StyleConstants.detailsLabelTextStyle
                      ),
                      TextSpan(
                        text: StringConstants.auto,
              ...
              Expanded(
                ...
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
                        text: StringConstants.whasPopupMessage2,
                        style: StyleConstants.detailsLabelTextStyle
                      ),
                      TextSpan(
                        text: StringConstants.auto,
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text(
                  StringConstants.whasPopupMessage3,
                  style: StyleConstants.detailsLabelTextStyle
                )
              ),
            ],
