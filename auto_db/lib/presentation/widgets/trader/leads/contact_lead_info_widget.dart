...
class ContactLeadInfoWidget extends StatelessWidget {
   @override
  ...
  Widget _getContent(BuildContext buildContext){
    return Container(
      ...
      child: Column(
        children: [
          Text(
            StringConstants.contactLeadInfoTitle,
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text(
                  StringConstants.contactLeadInfoMessage1,
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text(
                  StringConstants.contactLeadInfoMessage2,
                  style: StyleConstants.detailsLabelTextStyle
                )
              ),
            ],
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text(
                  StringConstants.contactLeadInfoMessage3,
                  style: StyleConstants.detailsLabelTextStyle
                )
              ),
            ],
