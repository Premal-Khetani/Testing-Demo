...
class GetVehicleFuelTypesUsecase extends BaseUsecase<List<AddVehicleLookup>,NoParams> {
  DropdownDataRepository _repository;

  GetVehicleFuelTypesUsecase(DropdownDataRepository repository){
    this._repository = repository;
  }

  @override
  Future<ResponseWrapper<List<AddVehicleLookup>>> call(NoParams params) async {
    return await _repository.getVehicleFuelTypes();
  }
}