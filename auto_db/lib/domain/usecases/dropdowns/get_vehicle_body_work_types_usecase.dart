...
class GetVehicleBodyWorkTypesUsecase extends BaseUsecase<List<AddVehicleLookup>,NoParams> {
  DropdownDataRepository _repository;

  GetVehicleBodyWorkTypesUsecase(DropdownDataRepository repository){
    this._repository = repository;
  }

  @override
  Future<ResponseWrapper<List<AddVehicleLookup>>> call(NoParams params) async {
    return await _repository.getVehicleBodyWorkTypes();
  }
}